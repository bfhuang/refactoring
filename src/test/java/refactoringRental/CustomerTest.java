...
public class CustomerTest {
	private static final String REGULAR_MOVIE_NAME = "Brave Heart";
	private static final String NEW_RELEASE_MOVIE_NAME = "Iron Man";
	private static final String CUSTOMER_NAME = "Binfang";
	private static final String CHILDREN_MOVIE = "Kongfu Panda";
	...
	public void setUp() throws Exception {
		regularMovie = new Movie(REGULAR_MOVIE_NAME, REGULAR);
		customer = new Customer(CUSTOMER_NAME);
		newReleaseMovie = new Movie(NEW_RELEASE_MOVIE_NAME, NEW_RELEASE);
		childrenMovie = new Movie(CHILDREN_MOVIE, CHILDREN);
	}
	...
	public void should_statement_for_regular_movie_and_rental_days_less_than_or_equal_to_2() {
		...
		assertThat(customer.statement(), is(result(CUSTOMER_NAME, REGULAR_MOVIE_NAME, expectedTotalAmount, expectedFrequentRenterPoints)));
	}
	...
	public void should_statement_for_new_release_movie_and_rental_days_less_than_or_equal_to_1() {
		...
		int expectedFrequentRenterPoints = 1;
		assertThat(customer.statement(), is(result(CUSTOMER_NAME, NEW_RELEASE_MOVIE_NAME, expectedTotalAmount, expectedFrequentRenterPoints)));
	}
	...
	public void should_statement_for_children_movie_and_rental_days_less_than_or_equal_to_3() {
		...
		int expectedFrequentRenterPoints = 1;
		assertThat(customer.statement(), is(result(CUSTOMER_NAME, CHILDREN_MOVIE, expectedTotalAmount, expectedFrequentRenterPoints)));
	}
	...
	public void should_statement_for_all_kinds_of_movie() {
		...
		assertThat(customer.statement(), is("Rental Record for Binfang\n\t" +
				"Brave Heart\t3.5\n" +
				"\tIron Man\t9.0\n" +
				"\tKongfu Panda\t1.5\n" +
				"Amount owed is 14.0\n" +
